...
def przygotuj_dane(filepath):
    #Funkcja wczytująca i czyszcząca pełen zbiór danych US Accidents.
    #Transformuje dane do postaci gotowej dla algorytmów uczenia maszynowego.
    ...
    print("3. Tworzenie zmiennej docelowej (Severity_Binary)")
    # 0 -> Niegroźne (1 i 2), 1 -> Groźne (3 i 4)
    ...
    # Uzupełnianie opadów medianą dla Hrabstwa i Miesiąca
    ...
    print("8. Podział na zbiór treningowy i testowy (80/20)")
